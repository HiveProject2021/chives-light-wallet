...
- Mainnet uses port 9444 and other constants and service names were changed for mainnet.
...
- Testnet is now running at the primary port of 59444. Update your routers appropriately. This opens 9444 for mainnet.
...
- Introducer now makes sure it only sends peer addresses to peers of peers that it can reach on port 9444 or their UPnP port.
